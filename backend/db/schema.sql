...
create table if not exists employers (
  ...
  industry text,
  subindustry text,
  ats_type text not null check (ats_type in ('greenhouse','lever','ashby','workday','talentbrew','workable','smartrecruiters','clinchtalent','oraclehcm','phenom','jobvite','applicantpro','icims','drupalcareers','teamtailor','pinpoint','eightfold','custom','manual')),
